...
<main class="main-content">
	<h1>Course Management</h1>
		<ul class="tabs">
			<li class="tab-link current" data-tab="tab-1">Add Course Section</li>
			<li class="tab-link" data-tab="tab-2">Create a Course</li>
		</ul>
		...
		<div class="grid group">
			...
			<div class="grid group">
				<div class="col-2 form-section">
					...
					<input class="form-input" type="text" name="CourseID" readonly value="CIA101">
				</div>
				<div class="col-2 form-section">
					<label for="CourseName">Course Name</label>
					<input class="form-input" type="text" name="CourseName" readonly value="Customer Relations">
				</div>
			</div>
